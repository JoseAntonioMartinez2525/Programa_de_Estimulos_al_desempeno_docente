...
class DictaminatorForm3_9Controller extends TransferController
{
    ...
    public function storeform39(Request $request)
    {
        ...
        try {
            ...
            if ($error = $this->validateEvaluationPeriod($request, 'form3_9')) {
                return $error;
            }
            ...
            $validatedData['form_type'] = 'form3_9';
                ...
                $existingRecord = DictaminatorsResponseForm3_9::where('dictaminador_id', $dictaminadorId)
            ...
            $response = DictaminatorsResponseForm3_9::updateOrCreate(
                [
