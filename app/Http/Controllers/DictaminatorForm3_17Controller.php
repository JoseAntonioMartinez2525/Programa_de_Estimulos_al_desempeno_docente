...
class DictaminatorForm3_17Controller extends TransferController
{
    ...
    public function storeform317(Request $request)
    {
        ...
        try {
            ...
            if ($error = $this->validateEvaluationPeriod($request, 'form3_17')) {
                return $error;
            }
            ...
            $validatedData['form_type'] = 'form3_17';
                ...
                $existingRecord = DictaminatorsResponseForm3_17::where('dictaminador_id', $dictaminadorId)
            ...
            $response = DictaminatorsResponseForm3_17::updateOrCreate(
                [
