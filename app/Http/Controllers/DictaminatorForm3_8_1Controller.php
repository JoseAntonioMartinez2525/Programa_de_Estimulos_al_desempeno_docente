...
class DictaminatorForm3_8_1Controller extends TransferController
{
    ...
    public function storeform381(Request $request)
    {
        ...
        try {
            ...
            if ($error = $this->validateEvaluationPeriod($request, 'form3_8_1')) {
                return $error;
            }
            ...
            $validatedData['form_type'] = 'form3_8_1';
                ...
                $existingRecord = DictaminatorsResponseForm3_8_1::where('dictaminador_id', $dictaminadorId)
            ...
            $response = DictaminatorsResponseForm3_8_1::updateOrCreate(
                [
