...
class DictaminatorForm3_15Controller extends TransferController
{
    ...
    public function storeform315(Request $request)
    {
        ...
        try {
            ...
            if ($error = $this->validateEvaluationPeriod($request, 'form3_15')) {
                return $error;
            }
            ...
            $validatedData['form_type'] = 'form3_15';
                ...
                $existingRecord = DictaminatorsResponseForm3_15::where('dictaminador_id', $dictaminadorId)
            ...
            $response = DictaminatorsResponseForm3_15::updateOrCreate(
                [
