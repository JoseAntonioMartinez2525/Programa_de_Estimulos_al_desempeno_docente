...
class DictaminatorForm3_6Controller extends TransferController
{
    ...
    public function storeform36(Request $request)
    {
        ...
        try {
            ...
            if ($error = $this->validateEvaluationPeriod($request, 'form3_6')) {
                return $error;
            }
            ...
            $validatedData['form_type'] = 'form3_6';
                ...
                $existingRecord = DictaminatorsResponseForm3_6::where('dictaminador_id', $dictaminadorId)
            ...
            $validatedData['obs3_6_1'] = trim($validatedData['obs3_6_1']) !== '' ? $validatedData['obs3_6_1'] : 'sin comentarios';



            $response = DictaminatorsResponseForm3_6::updateOrCreate(
                [
